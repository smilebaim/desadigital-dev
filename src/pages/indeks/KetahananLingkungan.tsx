...
// Data IKL (Indeks Ketahanan Lingkungan)
const iklData = {
  score: 0.68, // contoh skor IKL
  status: "Berkembang",
  components: [
  ...
  return (
    <div className="container mx-auto px-4 py-8 mt-16 mb-20">
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-center text-xl">Skor IKL Desa Saat Ini</CardTitle>
          </CardHeader>
          <CardContent>
            <GaugeChart value={iklData.score} status={iklData.status} size="lg" />
            ...
            <CardContent>
              <div className="h-[300px]">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={iklData.components} layout="vertical" margin={{ left: 50 }}>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Tren Skor IKL (4 Tahun Terakhir)
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="h-[300px]">
                 <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={iklData.trend}>
                    ...
                    <Tooltip />
                    <Legend />
                    <Bar dataKey="score" fill="#22c55e" name="Skor IKL Tahunan"/>
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </CardContent>
