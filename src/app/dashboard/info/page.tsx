              ...
              <TableBody>
                {loading ? (
                  ...
                  <TableRow key={item.id}>
                    ...
                    <TableCell>{item.createdAt ? new Date(item.createdAt.seconds * 1000).toLocaleDateString('id-ID') : '-'}</TableCell>
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem asChild>
                            <Link href={`/info/${item.id}`} target="_blank">
                              <Eye className="h-4 w-4 mr-2" />
                              Preview
                            </Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem asChild>
                             <Link href={`/dashboard/info/edit/${item.id}`}>
                                <Edit className="h-4 w-4 mr-2" />
                                Edit Konten
                              </Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem className="text-red-600" onClick={() => setPostToDelete(item.id)}>
      ...
      <AlertDialog open={!!postToDelete} onOpenChange={(open) => !open && setPostToDelete(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tindakan ini akan menghapus artikel secara permanen dan tidak dapat dibatalkan.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel onClick={() => setPostToDelete(null)}>Batal</AlertDialogCancel>
